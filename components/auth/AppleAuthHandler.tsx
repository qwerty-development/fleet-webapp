...
export default function AppleRedirectAuthHandler() {
  ...
  const initiateAppleAuth = () => {
    try {
      // Construct Apple OAuth URL directly (no script loading required)
      ...
      // Create Apple Auth URL with exact required parameters
      const appleAuthUrl =
      ...
      // Redirect to Apple for authentication (no script loading required)
  ...
  return (
    <div className="w-full">
      ...
      <button
        ...
        className="flex items-center justify-center w-full bg-white text-black border border-gray-300 rounded-lg py-2 px-4 hover:bg-gray-50 transition-colors"
      >
