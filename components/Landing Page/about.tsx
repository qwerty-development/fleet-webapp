      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl text-white font-bold mb-6">
            ...
            {" "}
            <span className="text-accent">Car Shopping</span>
          </h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Fleet connects car buyers with trusted dealerships through an intuitive 
            platform designed to make vehicle shopping seamless and enjoyable.
          </p>
        </motion.div>
        ...
        <div className="flex justify-center mb-12">
          <div className="inline-flex bg-black/40 p-1.5 rounded-xl backdrop-blur-sm border border-white/10">
            <motion.button
              className={`relative px-6 py-3 rounded-lg font-medium text-lg ${activeTab === 'buyers' ? 'text-white' : 'text-gray-400'}`}
            ...
            <motion.button
              className={`relative px-6 py-3 rounded-lg font-medium text-lg ${activeTab === 'dealers' ? 'text-white' : 'text-gray-400'}`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
                  ...
                  <p className="text-white/80">Find, compare, and connect with dealerships through our intuitive interface</p>
                </div>
              </motion.div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
                  <h3 className="text-2xl font-bold text-white mb-2">Powerful Dashboard</h3>
                  <p className="text-white/80">Comprehensive tools to manage your inventory and connect with buyers</p>
                </div>
              </motion.div>
            </div>
          </motion.div>
