...
export default function Hero() {
  ...
  return (
    <div className="w-full bg-white">
      ...
      <div className="h-[35vh] bg-black w-full bg-cover bg-center relative">
        {/* Gradient overlay with stronger fade at bottom */}
        ...
        {/* Main search container - positioned at the bottom of the image */}
                ...
                <form onSubmit={handleSearch} className="w-full">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full py-3 pl-12 pr-24 bg-white border-none rounded-full text-gray-800 focus:outline-none focus:ring-2 focus:ring-accent/60 shadow-inner"
                    />
                    ...
                    <button 
                      type="submit"
                      className="absolute right-1.5 top-1/2 transform -translate-y-1/2 px-5 py-2 bg-accent hover:bg-accent/90 text-white font-medium rounded-full transition-colors"
                    >
                      Search
                    </button>
                  </div>
