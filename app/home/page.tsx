...
function HomePageLoadingSkeleton() {
  return (
    <div>
      {/* Header skeleton */}
      <div className="sticky top-16 z-40 py-4 mb-4 border-b border-gray-700 shadow-md animate-pulse">
        <div className="flex items-center gap-2">
          <div className="flex-1 h-10 bg-gray-700 rounded"></div>
          <div className="h-10 w-24 bg-gray-700 rounded"></div>
          <div className="md:hidden h-10 w-10 bg-gray-800 rounded-full"></div>
        </div>
      </div>
      {/* BrandRow skeleton */}
      <div className="h-16 bg-gray-800 rounded mb-4 animate-pulse"></div>
      {/* CategorySelector skeleton */}
      <div className="h-10 bg-gray-800 rounded mb-8 animate-pulse"></div>
      {/* Car grid skeleton */}
