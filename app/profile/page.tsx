    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 pt-20 pb-12">
        <div className="max-w-4xl mx-auto">
          {/* Profile Header */}
          <div className="relative bg-gradient-to-br from-accent to-accent/10 rounded-3xl overflow-hidden mb-8">
          ...
          >
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <button className="w-full flex items-center justify-between p-4 rounded-lg bg-black-light hover:bg-black-light/80 transition-colors">
                  <div className="flex items-center">
              ...
              <div className="space-y-4">
                {(
                  ...
                  >
                    ...
                    >
                      <span
                        className={`h-5 w-5 rounded-full mx-0.5 ${
